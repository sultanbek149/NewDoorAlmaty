...
},{"@popperjs/core":"../node_modules/@popperjs/core/lib/index.js"}],"assets/js/app.js":[function(require,module,exports) {
"use strict";
...
var navbarContent = document.querySelector('#navbarToggleExternalContent');
var navbarButton = document.querySelector('[data-bs-target]');

var hideNavbarContent = function hideNavbarContent() {
  navbarContent.classList.toggle('show');
  navbarButton.classList.toggle('collapsed');
  navbarButton.ariaExpanded = false;
};

navbarContent.addEventListener('click', hideNavbarContent); // Email form Handling
...
function sendMail(e) {
  ...
  Email.send({
    ...
    Body: "\u0418\u043C\u044F:             ".concat(fullName, ".<br>\n               \u041D\u043E\u043C\u0435\u0440 \u0442\u0435\u043B\u0435\u0444\u043E\u043D\u0430:  ").concat(pNumber, ".")
  }).then(function () {
    return showAlert("Ваше сообщение успешно отправлено!", true);
  }).catch(function (e) {
    return showAlert("\u041F\u0440\u043E\u0441\u0442\u0438\u0442\u0435, \u0441\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u0435 \u043D\u0435 \u043E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u043E! ".concat(e.message), false);
  });
  clearFields();
}
...
function showAlert(message, isSuccess) {
  ...
  div.className = "alert ".concat(isSuccess ? 'alert-success' : 'alert-danger', " alert-message");
  div.appendChild(document.createTextNode(message));
  document.querySelector('.wrapper').appendChild(div); // Vanish in 3 seconds
